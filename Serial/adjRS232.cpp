...
ADJRS232 *ADJRS232::adj_RS232_instance = NULL;

ADJRS232 *ADJRS232::getAdjRS232instance()
{
	if (adj_RS232_instance == NULL)
	{
		adj_RS232_instance = new ADJRS232();
	}

	return adj_RS232_instance;
}

ADJRS232::ADJRS232()
{
	adj_RS232_instance = this;
}

int ADJRS232::open_comport(int comport_number, int baudrate, const char *mode, int flowctrl)
{
	int baudr,
		status;
...
int ADJRS232::poll_comport(int comport_number, unsigned char *buf, int size)
{
	int n;
...
int ADJRS232::send_byte(int comport_number, unsigned char byte)
{
...
int ADJRS232::send_buf(int comport_number, unsigned char *buf, int size)
{
...
void ADJRS232::close_comport(int comport_number)
{
	int status;
...
int ADJRS232::is_DCD_enabled(int comport_number)
{
	int status;
...
int ADJRS232::is_RING_enabled(int comport_number)
{
	int status;
...
int ADJRS232::is_CTS_enabled(int comport_number)
{
	int status;
...
int ADJRS232::is_DSR_enabled(int comport_number)
{
	int status;
...
void ADJRS232::enable_DTR(int comport_number)
{
	int status;
...
void ADJRS232::disable_DTR(int comport_number)
{
	int status;
...
void ADJRS232::enable_RTS(int comport_number)
{
	int status;
...
void ADJRS232::disable_RTS(int comport_number)
{
	int status;
...
void ADJRS232::flush_RX(int comport_number)
{
	tcflush(Cport[comport_number], TCIFLUSH);
}

void ADJRS232::flush_TX(int comport_number)
{
	tcflush(Cport[comport_number], TCOFLUSH);
}

void ADJRS232::flush_RXTX(int comport_number)
{
...
void ADJRS232::cputs(int comport_number, const char *text) /* sends a string to serial port */
{
	while (*text != 0)
		send_byte(comport_number, *(text++));
}

/* return index in comports matching to device name or -1 if not found */
int ADJRS232::get_port_nr(const char *devname)
{
	int i;
