...
/**
*   @brief  Save the active Midi Mixer parameters as XML file
*   @param  path settings XML file full path
*   @return 0 if done
*/
...
/**
*   @brief  Save the active String Synth parameters as XML file
*   @param  path settings XML file full path
*   @return 0 if done
*/
...
/**
*   @brief  Save the active PAD Synth parameters as XML file
*   @param  path settings XML file full path
*   @return 0 if done
*/
