...
#define _INSTRUMENT_NAME_KEYBOARD_MAPPER_STR_KEY		"Midi-Keyboard-Mapper"
...
#define _ALSA_NAME_CLIENT_MIDI_KEYBOARD_MAPPER_STR	_INSTRUMENT_NAME_KEYBOARD_MAPPER_STR_KEY
