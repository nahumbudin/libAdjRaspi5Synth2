/**
*	@file		dspAdjSynthVoiceKarplusStrong.cpp
*	@author		Nahum Budin
*	@date		25-Sep-2024
*	@version	1.2 
...
*	@param lev Kps_1 send level to channel 1 0.0 to 1.0
*	@return void
*/
void DSP_AdjSynthVoice::set_karplus_1_send_filter_1_level(float lev)
{
...
*	@return void
*/
void DSP_AdjSynthVoice::set_karplus_1_send_filter_1_level(int lev)
{
...
*/
float DSP_AdjSynthVoice::get_karplus_1_send_filter_1_level() 
{ 
	return 
		karplus_1_send_filter_1_level; 
}
...
*	@return void
*/
void DSP_AdjSynthVoice::set_karplus_1_send_filter_2_level(float lev)
{
...
*	@return void
*/
void DSP_AdjSynthVoice::set_karplus_1_send_filter_2_level(int lev)
{
...
*/
float DSP_AdjSynthVoice::get_karplus_1_send_filter_2_level() 
{ 
	return karplus_1_send_filter_2_level; 
}
