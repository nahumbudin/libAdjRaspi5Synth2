...
void DSP_Voice::set_pad_1_freq_mod_lfo(int lfo)
{
	...
	{
		wavetable_1_freq_mod_lfo = _LFO_NONE;
	}
...
void DSP_Voice::set_pad_1_amp_mod_lfo(int lfo)
{
	...
	{
		wavetable_1_amp_mod_lfo = _LFO_NONE;
	}
...
*	@return none
*/
void DSP_Voice::set_pad_1_amp_lfo_modulation(float mod_level, float mod_signal)
{
	...
	wavetable_1_amp_lfo_modulation = 1 - (1.0f - mod_sig) * level / 2.0f;
}
...
*	@return none
*/
void DSP_Voice::set_pad_1_amp_env_modulation(float mod_level, float mod_signal)
{
	...
	wavetable_1_amp_env_modulation = level * mod_sig;
}
...
*	@return none
*/
void DSP_Voice::set_pad_1_freq_lfo_modulation(float mod_level, float mod_signal)
{
	float mod_sig = mod_signal;
	...
	wavetable_1_freq_lfo_modulation = level * mod_sig;
}
...
*	@return none
*/
void DSP_Voice::set_pad_1_freq_env_modulation(float mod_level, float mod_signal)
{
	float level = mod_level;
	if (level < 0.0f)
	{
	...
	wavetable_1_freq_env_modulation = level * mod_sig;
}
