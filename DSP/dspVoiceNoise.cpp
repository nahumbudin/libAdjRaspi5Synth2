...
{ 
	...
	{
		noise_1_amp_mod_lfo = ((lfo - 1) / _NUM_OF_LFO_DELAY_OPTIONS + 1); // % _NUM_OF_LFOS) + 1;
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_lfo_modulation(float mod_level, float mod_signal)
{
	...
	noise_1_amp_lfo_modulation = 1 - (1.0f - mod_sig) * level / 2.0f;
}
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_env_modulation(float mod_level, float mod_signal)
{
	...
	noise_1_amp_env_modulation = level * mod_sig; 
}
